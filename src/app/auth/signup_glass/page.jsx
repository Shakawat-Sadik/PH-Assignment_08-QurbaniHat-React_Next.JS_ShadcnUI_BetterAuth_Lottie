...
export default function SignupPageBlock() {
  ...
  return (
    <div
      className=" flex items-center justify-center bg-linear-to-br from-slate-950 via-purple-900 to-slate-950 px-4 py-8">
        ...
        <GlassCardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-1.5">
                    {[
                      ...
                      <div key={rule.key} className="flex items-center gap-1.5">
                        <div
                          className={`h-1.5 w-1.5 rounded-full transition-colors ${validation[rule.key] ? "bg-green-400" : "bg-white/20"
                            }`} />
                        <span
                          className={`text-xs transition-colors ${validation[rule.key] ? "text-green-400" : "text-white/40"
                            }`}>
                          {rule.label}
                        </span>
                      </div>
            ...
            <div className="flex items-start gap-3 pt-2">
              ...
              <Label
                htmlFor="terms"
                className="text-white/70 cursor-pointer text-sm leading-relaxed font-normal flex-1 flex flex-wrap gap-x-1 gap-y-0.5">
            ...
            <GlassButton
              ...
              {isLoading ? (
                <>
                  <div
                    className="h-4 w-4 rounded-full border-2 border-white/30 border-t-white animate-spin mr-2" />
                  Creating account...
                </>
              ) : (
                <>
