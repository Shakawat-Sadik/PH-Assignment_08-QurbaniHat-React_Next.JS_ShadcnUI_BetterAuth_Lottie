    ...
    <div className="flex min-h-full flex-1 items-center justify-center bg-primary/10 px-4 py-6">
      ...
      <GlassCard className="w-full max-w-md">
        <GlassCardHeader className="space-y-2 text-center">
          ...
          <GlassCardTitle className="text-foreground text-xl">
            Sign into your account
          </GlassCardTitle>
          <GlassCardDescription className="text-foreground">
          ...
          <form id="signin" onSubmit={handleForm} className="space-y-4">
            <div className="space-y-2">
              ...
              <GlassInput
                ...
                name="email"
                required
                className="placeholder:text-accent-foreground bg-accent-foreground"
              />
            </div>
        ...
        <div className="bg-primary/10 pt-px rounded-b-[20px] overflow-hidden">
          <div className="flex flex-col items-center justify-center py-4">
            <div className="text-center text-sm text-foreground">
              ...
              <Link href="/auth/signup" className="text-card font-bold">
                {" "}
                Sign Up
              </Link>
            </div>
