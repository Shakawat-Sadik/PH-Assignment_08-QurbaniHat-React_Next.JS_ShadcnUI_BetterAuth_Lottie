    ...
    <LazyMotion features={domAnimation}>
      <div
        ...
        <m.div
          ...
          <div>
            <h4
              className="text-[#FF4400] font-medium text-lg leading-tight tracking-tighter">
              Revenue driven
            </h4>
            <div className="w-full h-px bg-[#FF4400] my-2"></div>
            <p
              className="text-[#FF4400] text-sm leading-tight tracking-tight max-w-[90%]">
        ...
        <m.div
          ...
          <div
            className="absolute top-5 left-5 bg-white/90 py-[4px] px-[8px] rounded-full text-xs font-semibold tracking-tighter text-black ">
            900k Liked
          </div>
        </m.div>
        ...
        <m.div
          ...
          <Image
            ...
            className="object-cover" />
          <div
            className="absolute bottom-5 right-5 bg-white/90 py-[4px] px-[8px] rounded-full text-xs font-semibold tracking-tighter text-black ">
            1.5M Viewed
          </div>
        </m.div>
      </div>
